    ...
    public class AuthenRepository : IAuthenRepository
    {
        ...
        public async Task<Token> GenerateToken(Account account)
        {
            ...
            if (roleName.Name.Equals("ADMIN"))
            {
                ...
                var token = new JwtSecurityToken(_configuration["Jwt:Issuer"], _configuration["Jwt:Audience"], claims, expires: DateTime.UtcNow.AddMinutes(120), signingCredentials: signIn);
